...
if __name__ == '__main__':
    loc_pigeon = [5, 8, -35, 0, 0, 0]
    loc_Penguin = [-12.585, 10.906, -45.686, 0, 0, 0]
    loc_box3 = [-21.496, -1.429, -24.649, 0, 0, 0]
    loc_box2 = [-10.055, 4.032, -30.630, 10, 20, 30]
    loc_box1 = [-11.709, -0.302, -44.058, 0, 0, 0]
    loc_seagull1 = [0.000, 40.000, -20.000, 0, 0, 0]
    loc_seagull2 = [-20.116, 47.255, -6.148, 0, 0, 0]
    loc_end = [-25, 20, -20, 0, 0, 0]

    # trajgen = traj.TrajQuinticContiguousTS(IKsolver=IK.IKSolverCUTER6DoFNum(), num_dofs=6)
    trajgen = traj.TrajQuinticContiguousTS(IKsolver=IK.IKSolverCUTER6DoFAna(), num_dofs=6)
