...
def J_6dof(theta1, theta2, theta3, theta4, theta5, theta6, l1, l2, l3, l4, l5):
    return np.array([[l5 * cos(theta1) * cos(theta4) * sin(theta2) * sin(theta3) * sin(theta5) - l4 * cos(theta1) * cos(
        theta2) * sin(theta3) - l4 * cos(theta1) * cos(theta3) * sin(theta2) - l5 * sin(theta1) * sin(theta4) * sin(
        theta5) - l5 * cos(theta1) * cos(theta2) * cos(theta5) * sin(theta3) - l5 * cos(theta1) * cos(theta3) * cos(
        theta5) * sin(theta2) - l5 * cos(theta1) * cos(theta2) * cos(theta3) * cos(theta4) * sin(theta5) - sin(
        theta1) * (l2 ** 2 + l3 ** 2) ** (1 / 2),
                      l4 * sin(theta1) * sin(theta2) * sin(theta3) - l4 * cos(theta2) * cos(theta3) * sin(
                          theta1) - l5 * cos(theta2) * cos(theta3) * cos(theta5) * sin(theta1) + l5 * cos(theta5) * sin(
                          theta1) * sin(theta2) * sin(theta3) + l5 * cos(theta2) * cos(theta4) * sin(theta1) * sin(
                          theta3) * sin(theta5) + l5 * cos(theta3) * cos(theta4) * sin(theta1) * sin(theta2) * sin(
                          theta5), l4 * sin(theta1) * sin(theta2) * sin(theta3) - l4 * cos(theta2) * cos(theta3) * sin(
            theta1) - l5 * cos(theta2) * cos(theta3) * cos(theta5) * sin(theta1) + l5 * cos(theta5) * sin(theta1) * sin(
            theta2) * sin(theta3) + l5 * cos(theta2) * cos(theta4) * sin(theta1) * sin(theta3) * sin(theta5) + l5 * cos(
            theta3) * cos(theta4) * sin(theta1) * sin(theta2) * sin(theta5),
                      l5 * cos(theta1) * cos(theta4) * sin(theta5) + l5 * cos(theta2) * cos(theta3) * sin(theta1) * sin(
                          theta4) * sin(theta5) - l5 * sin(theta1) * sin(theta2) * sin(theta3) * sin(theta4) * sin(
                          theta5),
                     ...
                     [cos(theta1) * (l2 ** 2 + l3 ** 2) ** (1 / 2) - l4 * cos(theta2) * sin(theta1) * sin(
                         theta3) - l4 * cos(theta3) * sin(theta1) * sin(theta2) + l5 * cos(theta1) * sin(theta4) * sin(
                         theta5) - l5 * cos(theta2) * cos(theta5) * sin(theta1) * sin(theta3) - l5 * cos(theta3) * cos(
                         theta5) * sin(
                         theta1) * sin(theta2) - l5 * cos(theta2) * cos(theta3) * cos(theta4) * sin(theta1) * sin(
                         theta5) + l5 * cos(
                         theta4) * sin(theta1) * sin(theta2) * sin(theta3) * sin(theta5),
                      l4 * cos(theta1) * cos(theta2) * cos(
                          theta3) - l4 * cos(theta1) * sin(theta2) * sin(theta3) + l5 * cos(theta1) * cos(theta2) * cos(
                          theta3) * cos(
                          theta5) - l5 * cos(theta1) * cos(theta5) * sin(theta2) * sin(theta3) - l5 * cos(theta1) * cos(
                          theta2) * cos(
                          theta4) * sin(theta3) * sin(theta5) - l5 * cos(theta1) * cos(theta3) * cos(theta4) * sin(
                          theta2) * sin(
                          theta5), l4 * cos(theta1) * cos(theta2) * cos(theta3) - l4 * cos(theta1) * sin(theta2) * sin(
                         theta3) + l5 * cos(theta1) * cos(theta2) * cos(theta3) * cos(theta5) - l5 * cos(theta1) * cos(
                         theta5) * sin(
                         theta2) * sin(theta3) - l5 * cos(theta1) * cos(theta2) * cos(theta4) * sin(theta3) * sin(
                         theta5) - l5 * cos(
                         theta1) * cos(theta3) * cos(theta4) * sin(theta2) * sin(theta5),
                      l5 * cos(theta4) * sin(theta1) * sin(
                          theta5) - l5 * cos(theta1) * cos(theta2) * cos(theta3) * sin(theta4) * sin(theta5) + l5 * cos(
                          theta1) * sin(
                          theta2) * sin(theta3) * sin(theta4) * sin(theta5),
                      l5 * cos(theta5) * sin(theta1) * sin(theta4) - l5 * cos(
                          theta1) * cos(theta2) * sin(theta3) * sin(theta5) - l5 * cos(theta1) * cos(theta3) * sin(
                          theta2) * sin(
                          theta5) + l5 * cos(theta1) * cos(theta2) * cos(theta3) * cos(theta4) * cos(theta5) - l5 * cos(
                          theta1) * cos(
                          theta4) * cos(theta5) * sin(theta2) * sin(theta3), 0],
                     [0, l4 * cos(theta2) * sin(theta3) + l4 * cos(theta3) * sin(theta2) + l5 * cos(theta2) * cos(
                         theta5) * sin(theta3) + l5 * cos(theta3) * cos(theta5) * sin(theta2) + l5 * cos(theta2) * cos(
                         theta3) * cos(theta4) * sin(theta5) - l5 * cos(theta4) * sin(theta2) * sin(theta3) * sin(
                         theta5),
                      l4 * cos(theta2) * sin(theta3) + l4 * cos(theta3) * sin(theta2) + l5 * cos(theta2) * cos(
                          theta5) * sin(theta3) + l5 * cos(theta3) * cos(theta5) * sin(theta2) + l5 * cos(theta2) * cos(
                          theta3) * cos(theta4) * sin(theta5) - l5 * cos(theta4) * sin(theta2) * sin(theta3) * sin(
                          theta5),
                      - l5 * cos(theta2) * sin(theta3) * sin(theta4) * sin(theta5) - l5 * cos(theta3) * sin(
                          theta2) * sin(theta4) * sin(theta5),
                     ...
                     [0, cos(theta1), cos(theta1),
                      sin(0.1488 - theta2) * cos(0.1488 + theta3) * sin(theta1) - sin(0.1488 + theta3) * sin(
                          theta1) * cos(
                          0.1488 - theta2), cos(theta1) * cos(theta4) + sin(theta4) * (
                              cos(0.1488 + theta3) * sin(theta1) * cos(0.1488 - theta2) + sin(0.1488 - theta2) * sin(
                          0.1488 + theta3) * sin(theta1)), sin(theta5) * (cos(theta1) * sin(theta4) - cos(theta4) * (
                             cos(0.1488 + theta3) * sin(theta1) * cos(0.1488 - theta2) + sin(0.1488 - theta2) * sin(
                         0.1488 + theta3) * sin(theta1))) + cos(theta5) * (
                              sin(0.1488 - theta2) * cos(0.1488 + theta3) * sin(theta1) - sin(0.1488 + theta3) * sin(
                          theta1) * cos(0.1488 - theta2))],
                     [0, sin(theta1), sin(theta1),
                      sin(0.1488 + theta3) * cos(theta1) * cos(0.1488 - theta2) - sin(0.1488 - theta2) * cos(
                          0.1488 + theta3) * cos(theta1), cos(theta4) * sin(theta1) - sin(theta4) * (
                              cos(0.1488 + theta3) * cos(theta1) * cos(0.1488 - theta2) + sin(0.1488 - theta2) * sin(
                          0.1488 + theta3) * cos(theta1)), cos(theta4) * sin(theta1) - sin(theta4) * (
                              cos(0.1488 + theta3) * cos(theta1) * cos(0.1488 - theta2) + sin(0.1488 - theta2) * sin(
                          0.1488 + theta3) * cos(theta1))],
                     [1, 0, 0,
                      - sin(0.1488 - theta2) * sin(0.1488 + theta3) - cos(0.1488 + theta3) * cos(0.1488 - theta2),
                      sin(theta4) * (sin(0.1488 - theta2) * cos(0.1488 + theta3) - sin(0.1488 + theta3) * cos(
                          0.1488 - theta2)),
